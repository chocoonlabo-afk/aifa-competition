    ...
    <div style={pageWrapper}>
      <div style={container}>
        ...
        <section style={section}>
          ...
          {/* Competition winner benefit */}
          <div style={noteBox}>
            <div style={smallLabel}>Competition winner benefit (draft)</div>
            <p>
              Winners of an AIFA competition (1st prize) will receive a special
              benefit for the Violin Grade Exam. This is planned as follows:
            </p>
            <ul style={list}>
              <li>
                <strong>If you are not currently on a subscription:</strong>{" "}
                you can use a <strong>free Grade credit</strong> for the
                per–grade option (50 USD value). The credit may be applied to
                any Grade level you choose.
              </li>
              <li>
