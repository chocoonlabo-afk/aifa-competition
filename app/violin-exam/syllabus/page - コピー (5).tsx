    ...
    <div style={pageWrapper}>
      <div style={container}>
        ...
        <section>
          ...
          <h1 style={h1}>AIFA Violin Grade Exam — Syllabus (draft)</h1>
          <p style={paragraph}>
        ...
        <section style={section}>
          ...
          <table style={table}>
            ...
            <tbody>
              ...
              <tr>
                <td style={td}>
                  <strong>Transcendent</strong>
                </td>
                <td style={td}>G109 – G144</td>
                <td style={td}>
                  <ul style={{ ...list, marginLeft: 16 }}>
                    <li>
                      Sarasate — <em>Zigeunerweisen</em> (Bravura
                      showpiece) — the end point of the AIFA Violin Grade Exam
                      syllabus
                    </li>
                    <li>
          ...
          <p style={subtle}>
            *The exact grade numbers and cut-off points may be adjusted in the
            final version. The titles themselves (Initiate / Adept / Ascendant /
            Transcendent) are fixed. The landmark pieces above are guidelines,
            not fixed exam repertoire.
          </p>
        </section>
        ...
        <section style={section}>
          <h2 style={h2}>Example description — Initiate (early grades)</h2>
          <p style={paragraph}>
            The detailed PDF syllabus will eventually describe each grade one by
            one. Below is a simple example of how the early Initiate grades
            might be written. These are draft ideas and will be refined.
          </p>

          <h3 style={h3}>Initiate — lower range (example: G1 – G4)</h3>
        ...
        <section style={section}>
          <h2 style={h2}>From Adept to Transcendent — focus growth</h2>
          <p style={paragraph}>
            From the Adept band upwards, the syllabus gradually includes:
          </p>
          <ul style={list}>
            ...
            <li>
              ...
              in the Ascendant and Transcendent bands
            </li>
          </ul>
        ...
        <section style={section}>
          ...
          <ul style={list}>
            <li>
              ...
              <strong>Transcendent</strong> level (around{" "}
