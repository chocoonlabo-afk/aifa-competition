  ...
  return (
    <main style={wrapper}>
      <article style={card}>
        ...
        <p style={p}>
          AIFA International Music Competition (AIFA) is an online-based classical music
          competition that aims to support young musicians around the world. The competition
          combines <strong>AI-supported analysis</strong> with{" "}
...
/>
        ...
        <p style={p}>
          The early edition of AIFA will start as a compact online competition. In the
        ...
        <p style={p}>
          AIFA is organised by the AIFA International Music Competition Office. Detailed
          information about the jury members and advisory board will be announced on this
          website.
        </p>
        ...
        <div style={legal}>
          Legal:
          {" "}
          <a style={link} href="/legal/terms">Terms</a>
          {" · "}
          <a style={link} href="/legal/privacy">Privacy</a>
          {" · "}
          <a style={link} href="/legal/refund">Refund</a>
          {" · "}
          <a style={link} href="/legal/media-consent">Media</a>
        </div>
      </article>
    </main>
  );
